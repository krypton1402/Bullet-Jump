...
namespace BulletJumpLibrary.Graphics
{
    ...
    {
        /// <summary>
        /// Возвращает или задает исходную текстуру, частью которой является данная область текстуры.
        /// </summary>
        public Texture2D Texture { get; set; }
        /// <summary>
        /// Возвращает или задает исходную прямоугольную границу этой области текстуры внутри исходной текстуры
        /// </summary>
        public Rectangle SourceRectangle { get; set; }
        /// <summary>
        /// Возвращает ширину этой области текстуры в пикселях.
        /// </summary>
        public int Width => SourceRectangle.Width;
        /// <summary>
        /// Возвращает высоту этой области текстуры в пикселях.
        /// </summary>
